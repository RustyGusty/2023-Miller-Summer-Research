...
maskxin = min(round(handles.maska(1)),round(handles.maska(2)));
maskxfin = max(round(handles.maska(1)),round(handles.maska(2)));
maskyin = min(round(handles.maskb(1)),round(handles.maskb(2)));
maskyfin = max(round(handles.maskb(1)),round(handles.maskb(2)));
...
set(handles.smean,'String',num2str(mean(resstatmat),'%5.0f', 'omitnan'));
set(handles.sstd,'String',num2str(std(double(resstatmat)),'%5.0f', 'omitnan'));
